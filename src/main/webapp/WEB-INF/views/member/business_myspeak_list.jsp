		...
		<section class="container-lg mb-4">
			<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item text-danger bold" aria-current="page">말해볼텨</li>
				</ol>
			</nav>
		</section>
...
function createPaginationButtons() {
  ...
  for (var i = 1; i <= totalPages; i++) {
    paginationButtons.append('<button class="btn w-10 page-button">' + i + '</button>');
  }
...
function navigateToPage() {
  var url = "/business_myspeak_list.do?page=" + currentPage;
  // 페이지 이동을 수행하는 코드를 추가.
