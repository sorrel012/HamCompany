...
<body>
	...
	<div
		...
		<div class="col-9 container-lg">
			...
			<form id="editform1" method="POST" class="form-control p-4 bg-secondary bg-opacity-10" action="/business_profile1_editok.do">
				...
				<div class="fw-bold d-lg-flex align-items-center">
					<div class="w-50 me-5 a-email">
						...
						<input class="form-control" type="email" id="email" name="b_email" value="${dto.b_email}">
					</div>
					<div class="w-50">
						...
						<div class="d-flex btn-group">
							<input class="form-control" id="sample6_address" name="bd_address"
								...
								type="text" value="${dto.bd_address}" readonly>
							<input type="button" class="btn w-25 search-btn" value="주소 검색" onclick="sample6_execDaumPostcode()">
						</div>
						<div>
							<input class="form-control mt-2" id="address_detail" name="bd_address_detail"
							style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;"
							type="text" value="${dto.bd_address_detail}" required onchange="checkFields()">
						</div>
					</div>
				</div>
				<div class="fw-bold d-lg-flex align-items-center mt-4">
					<div class="w-50 me-5">
						...
						<input class="form-control" type="text" id="phone" name="b_tel" value="${dto.b_tel}">
					</div>
					<div class="w-50">
						<p class="m-0 mt-sm-2 mt-md-2 mt-lg-0 mb-2 w-auto">사업자 번호</p>
						<input class="form-control" type="text" value="${dto.b_num}"
							readonly>
					</div>
				</div>
