      ...
      <div class="headline">
         <h2>
            <span class="fw-bold" style="color: #FF914D">함!</span> <span
               class="text-primary fw-bold">말해</span>볼텨 <span class="fw-bold">[사업자]</span>
         </h2>
         <button type="button" class="btn btn-danger"
            style="width: 100px; height: 40px;" onclick="location.href='/speakadd.do?type=2'">글쓰기</button>
      </div>
      ...
      <c:if test="${count != 0}">
         <div class="container-sm border border-1 border-dark border-opacity-25 rounded h-100">
            <c:forEach items="${list}" var="dto">
               <div class="container-fluid list p-2 border-bottom " onclick="location.href='/speakbdetail.do?&seq=${dto.sb_seq}'">
                  <div class="d-flex align-items-center mb-2">
                     <img class="profile" src="/resources/img/로고.png">
                     <div class="profile-detail">
                        <p class="name">${dto.bd_name}(${dto.b_id})</p>
                        <p class="time">${dto.sb_regdate}</p>
                     </div>
                  </div>
                  ...
                  <div class="d-flex align-items-center pb-2" >
                     ...
                     <span class="fst-normal"style="margin-right: 20px;">${dto.sb_hit}</span>
                     </i>
                  </div>
               </div>
            </c:forEach>
      ...
      <c:if test="${count == 0}">
         ...
         <div>
            ...
            <div class="w-100 d-flex justify-content-center" >
               <button type="button" class="btn btn-light btn-lg mb-5 text-dark" style="background-color : #ededed;" onclick="location.href='/speakblist.do'">전체 리스트 보기</button>
            </div>
             </div>
      </c:if>
...
<script>
   ...
   function search() {
      ...
      if ($('#word').val() == "") {
         ...
         location.href="/searchblist.do?word="+$('#word').val();
      }
   ...
   $('#sortList').change(function () {
      ...
      location.href="/speakblist.do?sort="+$(this).val();
   }) 
   ...
   function navigateToPage() {
     var url = "/speakblist.do?page=" + currentPage;
     // 페이지 이동을 수행하는 코드를 추가.
