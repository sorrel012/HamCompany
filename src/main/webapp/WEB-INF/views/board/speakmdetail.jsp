...
<body>
	...
	<section class="container-md mt-4 mb-5">
		...
		<div
			...
			<div class="p-2">
				<div class="fs-3 mt-2 fw-semibold">${dto.sm_subject}</div>

				<div class="d-flex justify-content-between mt-2">
					<div class="d-flex">
						<div class="pe-3 me-3 border-end" style="color: #FF9170;">${dto.m_name}</div>
						<div>${dto.sm_regdate}</div>
					</div>
					<div>
						<i class="bi bi-eye me-2">
						<span class="fst-normal">${dto.sm_hit}</span>
						</i>
					</div>
				</div>
			</div>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-secondary" style="border : none;" data-bs-dismiss="modal" onclick="location.href='/deleteSMComment.do?seq=${dto.sm_seq}'">삭제</button>
			...
			<form class="d-flex my-4">
				<div class="input-group">
					<input class="form-control" type="text" placeholder="댓글 작성하기"
						aria-label=".form-control-lg example" id="smc_content" name="smc_content">
		...
		<div class="d-flex my-4 flex-row-reverse">
			<button type="button" class="btn btn-outline-secondary"
				...
				onclick="location.href='/speakmlist.do';">
